...
def parse_args(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--B_num', type=int, default=4)
    parser.add_argument('--lambda_num', type=int, default=4)
    parser.add_argument('--mlora_temperature', type=float, default=1.0)
